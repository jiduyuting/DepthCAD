...
CUDA_VISIBLE_DEVICES="${GPU_A}" bash scripts/runs/flow/run_exp_a.sh >"${LOG_DIR}/exp_a.log" 2>&1 &
pid_a=$!
CUDA_VISIBLE_DEVICES="${GPU_B}" bash scripts/runs/flow/run_exp_b.sh >"${LOG_DIR}/exp_b.log" 2>&1 &
pid_b=$!
CUDA_VISIBLE_DEVICES="${GPU_C}" bash scripts/runs/flow/run_exp_c.sh >"${LOG_DIR}/exp_c.log" 2>&1 &
pid_c=$!
